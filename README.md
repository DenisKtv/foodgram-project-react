...
![example workflow](https://github.com/DenisKtv/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)  
...
```bash
git clone https://github.com/DenisKtv/foodgram-project-react.git
...
[http://51.250.97.108/api/docs/](http://51.250.97.108/api/docs/)

## Авторы
[Костив Д.А.](https://github.com/DenisKtv) - Python разработчик. Сделал деплой и разработал бэкенд для сервиса Foodgram.  
